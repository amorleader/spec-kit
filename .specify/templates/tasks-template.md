...
**Tests**: Include test tasks for every behavior change. Define tests first and ensure they fail before implementation.
...
- [ ] T004 Define or update CLI command contract docs for impacted flows
...
- [ ] T010 Configure structured diagnostics (logs/metrics/traces) for key failure paths
...
- [ ] T018 [US1] Add structured diagnostics for user story 1 operations
- [ ] T019 [US1] Update CLI outputs/error codes for user story 1 behavior
...
- [ ] TXXX [P] Additional unit tests for changed behavior in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Update semantic version and changelog notes for public behavior changes
