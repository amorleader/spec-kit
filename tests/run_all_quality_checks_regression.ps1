...
function Invoke-Runner {
    ...
    try {
        $out = & powershell -ExecutionPolicy Bypass -File $script @Args 2>&1
...
$r1 = Invoke-Runner -Args @('-Json', '-IncludeDocsOnly')
...
$r2 = Invoke-Runner -Args @('-IncludeDocsOnly')
...
$r3 = Invoke-Runner -Args @('-Json', '-IncludeDocsOnly')
